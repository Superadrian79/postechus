...
<!-- End Google Tag Manager -->
	...
	<meta name="robots" content="all" /><meta name="googlebot" content="index, follow" />
  	<meta name="description" content="Propuestas innovadoras en la Arquitectura de Servicios de Información y soluciones que desarrollamos con el fin de crear un entorno eficiente y seguro para su organización.">
  	<meta name="keywords" content="Monitoreo de Infraestructura, Correlacion de Logs, Sistema de gestion de incidentes, IDS, Reconstruccion de Trafico, Inventario automatico de dispositivos, Monitoreo de redes sociales, NOC, SOC, CSIRT, ADB CONNECT, ITIL V 2.1, ITIL V  3, PCI DSS, MAAGTIC SI, ISO 27035, COBIT 5, ISO 2700">
...
<p>Cada empresa presenta problemas o necesidades influidas por el entorno en el que trabaja. <b class="blue">POSTECH</b> proporciona soluciones enfocadas en las necesidades especificas tras el análisis de cada situación, implementando mejoras que optimizan el rendimiento global del cliente.</p>

<p><img class="img-responsive" src="../images/soluciones.jpg" alt="Soluciones Postech"></p>
