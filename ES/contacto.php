...
<div class="col_full just"><div style="text-align:center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Por favor agregue sus datos en los campos a continuación. <strong>Los campos marcados con rojo son obligatorios.</strong></div></div>
...
<div class="container" >
    ...
    <div class="form-group">
      <label class="control-label col-sm-2" for="cname"><span style="color:#F00; font-size:18px;">&#8226;</span> Nombre:</label>
      <div class="col-sm-10">
        <input name="cname" type="text" class="form-control" id="cname" placeholder="Ingrese su Nombre" required>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input name="email" pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$" type="text" class="form-control" id="email" placeholder="Ingrese su Email" required>
      </div>
    </div>
    
    
    <div class="form-group">
   <label class="control-label col-sm-2" for="comentarios"><span style="color:#F00; font-size:18px;">&#8226;</span> Comentarios:</label>
      <div class="col-sm-10">
