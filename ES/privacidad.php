...
<img src="../images/arr.png" alt="."> Nombre<br>
<img src="../images/arr.png" alt="."> Razón Social de la Empresa<br>
<img src="../images/arr.png" alt="."> Marca Comercial de su empresa<br>
<img src="../images/arr.png" alt="."> Puesto que ocupa en su trabajo<br>
<img src="../images/arr.png" alt="."> Dirección<br>
<img src="../images/arr.png" alt="."> Dirección Fiscal<br>
<img src="../images/arr.png" alt="."> RFC<br>
<img src="../images/arr.png" alt="."> Teléfonos<br>
<img src="../images/arr.png" alt="."> Extensión telefónica<br>
<img src="../images/arr.png" alt="."> Teléfono Celular<br>
<img src="../images/arr.png" alt="."> Número de Fax<br>
<img src="../images/arr.png" alt="."> Correo electrónico Principal<br>
<img src="../images/arr.png" alt="."> Correo electrónico alternativo<br>
<img src="../images/arr.png" alt="."> Dirección de su página web<br>
<img src="../images/arr.png" alt="."> Nombre de usuario en Twitter<br><br>

<p>Postech no recaba datos considerados como sensibles de acuerdo al Artículo 3 de la LEY FEDERAL DE PROTECCIÓN DE DATOS PERSONALES EN POSESIÓN DE LOS PARTICULARES (DOF) Postech también recopila otro tipo de información que no lo puede identificar personalmente cada vez que accede una página los sitios web de Postech.us. Esta información incluye la dirección de Protocolo de Internet (IP) y el nombre de dominio. Una dirección IP es un número que asigna automáticamente la computadora del ISP a la computadora de EL CLIENTE o usuario a través del cual usted tiene acceso al Web y un nombre de dominio es el nombre de la computadora del ISP a través de la cual EL CLIENTE o usuario tiene acceso al Web. Postech  utiliza esta información añadida para medir el número de visitas a su sitio, el tiempo promedio que pasa en él cada usuario, el número de páginas visitadas y diversas otras estadísticas del uso del sitio. Este monitoreo ayuda a evaluar cómo se usa el sitio Web para mejorar en forma continua el contenido del mismo y EL CLIENTE acepta que Postech lleve a cabo el monitoreo en cuestión para dichos efectos.</p>

<p>Si EL CLIENTE utiliza alguno de los formularios de registro de Postech.us, éste último le hará llegar un acuse de recibo en línea para confirmar que ha recibido su contacto. Si cuando llene algún formulario decide ser parte de la lista de correos de Postech.us, también puede recibir otro contacto sobre los servicios de PostecH Cyber Security Solutions o cualquiera de sus empresas filiales con otros temas que pudieran ser de interés para EL CLIENTE. EL CLIENTE podrá cancelar su afiliación a la lista de correos cuando lo desee mediante el procedimiento que se indica en el correo que le fue enviado.</p>

<p>Postech.us. utiliza "cookies" para ayudarlo a personalizar su práctica en línea dentro de sus sitios Web. Un cookie es un archivo de texto situado por un servidor de páginas Web en el disco duro del equipo del usuario. Los cookies no se pueden utilizar para ejecutar programas o transmitir virus a su equipo; únicamente se asignan al usuario y sólo pueden ser leídos por el servidor Web que pertenece al dominio que lo emitió.</p>
...
<p>Postech.us usa cookies para almacenar información para registrar algunos valores de visita a nuestro sitio y llevar estadísticas que nos permiten mejorarlo. También usa cookies para almacenar el nombre de EL CLIENTE o usuario cada vez que manda un formulario en el sitio de Postech.us con el objeto de saludarle por su nombre cuando regrese a visitar el sitio en cuestión.</p>

<p>Postech.us utiliza la información que EL CLIENTE proporciona para contactarlo en respuesta a la solicitud realizada. Postech.us puede compartir la información que se le haya proporcionado con otras empresas propiedad de PostecH Cyber Security Solutions </p>

<p>Limitación de uso y divulgación de la información</p>

<p>Postech utiliza la información proporcionada por EL CLIENTE con el fin único de atenderle, esta información no es compartida con terceros, ni con ninguna otra empresa que no sea Postech.</p>
...
<p>El cliente puede modificar la información que contiene su perfil cada vez que lo desee ingresando a lso diferentes servicios ofrecidos a traves del sitio web de Postech.us. De igual manera puede oponerse a que Postech tenga más su información y solicitar la cancelación de servicios y la eliminación del registro de sus datos personales.</p>
