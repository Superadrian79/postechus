...
<!-- End Google Tag Manager -->
	...
	<meta name="robots" content="all" /><meta name="googlebot" content="index, follow" />
  	<meta name="description" content="Disciplina de inteligencia artificial que tiene como objetivo permitir la comunicación hablada entre seres humanos y computadoras.">
  	<meta name="keywords" content="reconocimiento de voz, automático, lectura acústica, fonética, fonología, léxica, sintáctica, semántica, pragmática, interpretación, exportar, órdenes, convertir, traducir">
	...
	<!-- Document Title
	============================================= -->
	<title>RAH Reconocimiento Automático del Habla</title>
		...
		<section id="page-title" class="page-title-dark">
			...
			<div class="container clearfix">
				...
				<ol class="breadcrumb">
					...
					<li class="active">Reconocimiento de Voz</li>
				</ol>
			</div>
...
<p>El reconocimiento automático del habla (RAH) o reconocimiento automático de voz es una disciplina de la inteligencia artificial que tiene como objetivo permitir la comunicación hablada entre seres humanos y computadoras. El problema que se plantea en un sistema de este tipo es el de hacer cooperar un conjunto de informaciones que provienen de diversas fuentes de conocimiento (acústica, fonética, fonológica, léxica, sintáctica, semántica y pragmática), en presencia de ambigüedades, incertidumbres y errores inevitables para llegar a obtener una interpretación aceptable del mensaje acústico recibido.</p>

<p>Nuestro sistema de reconocimiento de voz es una herramienta computacional capaz de procesar la señal de voz emitida por el ser humano y reconocer la información contenida en ésta, convirtiéndola en texto o emitiendo órdenes que actúan sobre un proceso. Permitiendo asi implemetar este tipo de soluciones para controles de acceso, administración de identeidades sobre sistemas de control ó ejecucion de procesos criticos mediante comandos de voz.</p>
