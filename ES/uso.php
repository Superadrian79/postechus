...
?>
		...
		<section id="page-title" class="page-title-dark">
			...
			<div class="container clearfix">
				...
				<ol class="breadcrumb">
					<li class="active">T&eacute;rminos de Uso</li>
				</ol>
			</div>
...
<p>Para Servicio al Cliente, por favor diríjase a:</p>
