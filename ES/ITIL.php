...
<!-- End Google Tag Manager -->
	...
	<meta name="robots" content="all" /><meta name="googlebot" content="index, follow" />
  	<meta name="description" content="El curso ITIL® V3  es un recurso útil tanto para las personas que deseen profundizar un poco más en ITIL® como para los interesados en obtener una certificación oficial">
  	<meta name="keywords" content="curso ITIL® V3, GESTIÓN DE SERVICIOS, Information Technologies Infraestructure Library">
...
<p>El curso ITIL® V3 nace con la idea de ofrecer una pequeña introducción al conjunto de Mejores Prácticas de ITIL®, también conocido como Information Technologies Infraestructure Library.</p>

<p>Su objetivo primordial es ofrecer a los usuarios hispanohablantes una referencia a la que puedan aferrarse y a partir de la cual empiecen a iniciarse en los métodos y conceptos de ITIL®.</p>

<p>Obviamente el curso no tiene ninguna intención de sustituir a la formación oficial, sino que lo que trata es de ser un recurso útil tanto para las personas que deseen profundizar un poco más en ITIL® como para los interesados en obtener una certificación oficial complementaria a su formación, el “Foundation Certificate en Gestión de Servicios TI”.</p>
