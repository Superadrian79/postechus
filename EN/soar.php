				...
				<div class="section header-stick">
					<div class="container clearfix">
						...
						<div style="text-align: justify;">
							...
							<p>The term was originally coined by Gartner, who also defined the three capabilities. Threat and vulnerability management (orchestration) covers technologies that help remediate cyber threats, while automation of security operations (automation) relates to technologies that enable automation and orchestration within operations.</p>
							<p>As many of the cyber threats faced by companies will require multiple technologies to combat them and multiple team members to perform manual tasks and link the information, the remediation organization must be seamless. While orchestration aims for efficiency when executing threat remediation, automation aims to reduce the time for these actions using machine learning, making the orchestration process itself more efficient.</p>
							<p>Security Incident Response (Response) is how the response to a threat is planned, managed, coordinated, and monitored. The response measures the process of responding to a threat or vulnerability and can be used to inform strategy.</p>
						</div>
