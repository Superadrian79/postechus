...
<div class="container clearfix">
					...
					<div class="col_one_third">
						...
						<div class="heading-block fancy-title nobottomborder title-bottom-border">
							<h4><span>Telecommunications</span></h4>
						</div>
					...
					<div class="col_one_third col_last">
						...
						<div class="heading-block fancy-title nobottomborder title-bottom-border">
							<h4><span style="letter-spacing:-1.5px; text-align:justify">BD & RDBMS Analysis / modeling</span></h4>
						</div>
...
<div class="container clearfix">
					...
					<div class="col_one_third">
						...
						<div class="heading-block fancy-title nobottomborder title-bottom-border">
							<h4><span>Server Hardware</span></h4>
						</div>
					...
					<div class="col_one_third col_last">
						...
						<div class="heading-block fancy-title nobottomborder title-bottom-border">
							<h4><span>Design Datacenters</span></h4>
						</div>
...
<div class="container clearfix">
					...
					<div class="col_one_third">
						...
						<div class="heading-block fancy-title nobottomborder title-bottom-border">
							<h4><span>Virtualization</span></h4>
						</div>
					...
					<div class="col_one_third col_last">
						...
						<div class="heading-block fancy-title nobottomborder title-bottom-border">
							<h4><span style="letter-spacing:-1.5px;">systems based on open source</span></h4>
						</div>
...
<div class="container clearfix">
					...
					<div class="col_one_third">
						...
						<div class="heading-block fancy-title nobottomborder title-bottom-border">
							<h4><span style="letter-spacing:-2px;">traffic Analysis & reconstruction</span></h4>
						</div>
					...
					<div class="col_one_third col_last">
						...
						<div class="heading-block fancy-title nobottomborder title-bottom-border">
							<h4><span>Incident Management</span></h4>
						</div>
...
<p>We specialize in programming and application development on open platforms for different sectors for more than 10 years since our inception we have worked to connect more and more companies and businesses.</p>
<p>We are shaped by a team of multidisciplinary specialists with expertise in areas such as vulnerability analysis , penetration testing , business intelligence (BI ) , modeling databases, programming languages ​​high performance and portability , graphic design, Web design, three-dimensional design , audio editing and video, and data transmission services via satellite links.</p>
