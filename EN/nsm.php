		...
		<section id="content">
			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
					...
					<p style="text-align:center"><img src="../images/NSM-Logo.png" alt="NSM" style="width:30%; height:30%;"></p>
					<p style="text-align:center"><h3 class="blue">NSM ®</h3></p>
